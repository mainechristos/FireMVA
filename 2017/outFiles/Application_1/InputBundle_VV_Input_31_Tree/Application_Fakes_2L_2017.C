...
void Application_Fakes_2L_2017(){
  ...
  TFile *input(0);   
    input = TFile::Open("/cms/mchristos/ANN/FireMVA/2017/runPlotter_2L_NTupleMaker_2017/InputBundle_VV_Input_31_Tree.root");
    //input = TFile::Open("outFiles/Application_1/InputBundle_VV_Input_31_Tree/BDT3_tree.root");
  ...
  TTreeReaderValue<vector<float>> inLightLeptonPt(myReader, "LightLeptonPt");
   ...
   TTreeReaderValue<vector<int>> inLightLeptonFlavor(myReader, "LightLeptonFlavor");
    ...
    TFile *endfile = new TFile("outFiles/Application_1/InputBundle_VV_Input_31_Tree/BDT1_tree.root","RECREATE");   
