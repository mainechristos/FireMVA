...
void Application_Fakes_Leptons_2017(){
  ...
  TFile *input(0);   
    input = TFile::Open("/cms/mchristos/ANN/FireMVA/2017/runPlotter_3L_NTupleMaker_2017/InputBundle_X+G_Input_85_Tree.root");
    //input = TFile::Open("outFiles/Application_1/InputBundle_X+G_Input_85_Tree/BDT3_tree.root");
