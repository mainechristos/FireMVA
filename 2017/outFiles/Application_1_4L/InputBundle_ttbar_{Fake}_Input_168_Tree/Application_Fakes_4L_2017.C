...
void Application_Fakes_4L_2017(){
  ...
  reader1->BookMVA( "BDTG method",  "/cms/mchristos/ANN/FireMVA/L3Only/dl/weights/fire_MVA_FakeElectrons_BDT.weights.xml");
  reader2->BookMVA( "BDTG method",  "/cms/mchristos/ANN/FireMVA/L3Only/dl/weights/fire_MVA_FakeMuons_BDT.weights.xml");


  TFile *input(0);   
    //input = TFile::Open(" /cms/heindl/software/CMSSW_10_4_ROOT614_X_2018-10-19-2300/src/pyPlotter16and17_No2/pyPlotter/runPlotter_4L_NTupleMaker_2017/InputBundle_ttbar_{Fake}_Input_168_Tree.root");
    input = TFile::Open("outFiles/Application_1_4L/InputBundle_ttbar_{Fake}_Input_168_Tree/BDT2_tree.root");
  ...
  TTreeReaderValue<vector<float>> inLightLeptonPt(myReader, "LightLeptonPt");
   ...
   TTreeReaderValue<vector<int>> inLightLeptonFlavor(myReader, "LightLeptonFlavor");
    ...
    TFile *endfile = new TFile("outFiles/Application_1_4L/InputBundle_ttbar_{Fake}_Input_168_Tree/BDT1_tree.root","RECREATE");   
