...
void Application_Fakes_4L_2017(){
  ...
  TFile *input(0);   
    //input = TFile::Open(" /cms/heindl/software/CMSSW_10_4_ROOT614_X_2018-10-19-2300/src/pyPlotter16and17_No2/pyPlotter/runPlotter_4L_NTupleMaker_2017/InputBundle_Other_{Fake}_Input_191_Tree.root");
    input = TFile::Open("outFiles/Application_1_4L/InputBundle_Other_{Fake}_Input_191_Tree/BDT2_tree.root");
  ...
  TTreeReaderValue<vector<float>> inLightLeptonPt(myReader, "LightLeptonPt");
   ...
   TTreeReaderValue<vector<int>> inLightLeptonFlavor(myReader, "LightLeptonFlavor");
    ...
    TFile *endfile = new TFile("outFiles/Application_1_4L/InputBundle_Other_{Fake}_Input_191_Tree/BDT1_tree.root","RECREATE");   
