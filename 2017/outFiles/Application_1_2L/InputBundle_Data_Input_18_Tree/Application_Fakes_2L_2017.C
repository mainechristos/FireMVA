...
void Application_Fakes_2L_2017(){
  ...
  TFile *input(0);   
    //input = TFile::Open("/cms/heindl/software/CMSSW_10_4_ROOT614_X_2018-10-19-2300/src/pyPlotter16and17_No2/pyPlotter/runPlotter_2L_NTupleMaker_2017/InputBundle_Data_Input_18_Tree.root");
    input = TFile::Open("outFiles/Application_1_2L/InputBundle_Data_Input_18_Tree/BDT2_tree.root");
  ...
  TTreeReaderValue<vector<float>> inLightLeptonPt(myReader, "LightLeptonPt");
   ...
   TTreeReaderValue<vector<int>> inLightLeptonFlavor(myReader, "LightLeptonFlavor");
    ...
    TFile *endfile = new TFile("/cms/multilepton-2/mchristos/BDTSkims/2017outFiles/Application_1_2L/InputBundle_Data_Input_18_Tree/BDT3_tree.root","RECREATE");   
