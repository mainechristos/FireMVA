...
void Train_Fakes_TT_3params( TString myMethodList = "" )
{
   ...
   TString outfileName( "class_perf/fire_MVA_TT_3params.root" );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

   TMVA::Factory *factory = new TMVA::Factory( "fire_MVA_TT_3params", outputFile,
   ...
   dl->PrepareTrainingAndTestTree( "1", "1",
                                        "nTrain_Signal=78208:nTrain_Background=45820:SplitMode=Random:NormMode=NumEvents:!V" );
