void plot_fakesEff_TT_OffDiagonal(){
  ...
  TFile *fake_input_iso = TFile::Open( "/cms/mchristos/ANN/FireMVA/TT_FakeMuonTree.root" ); 
  std::cout << "--- Using fakes input file: " << fake_input_iso->GetName() <<         std::endl;

  TFile *nonfake_input_iso = TFile::Open( "/cms/mchristos/ANN/FireMVA/TT_NonFakeMuonTree.root" ); 
 ...
 float fake_events_bdt1 = 0.0;
  ...
  //Get skimmed TTrees (copied from /cms/multilepton-2/hsaka/Workspace/pyPlotter-2018Maxi/pyPlotter/FIREMVA/)
  TFile *fake_input_bdt1 = TFile::Open( "/cms/mchristos/ANN/FireMVA/outFiles/BDTnoMuonPt_TT_FakeMuonTree.root" ); 
  std::cout << "--- Using fakes input file: " << fake_input_bdt1->GetName() <<         std::endl;

  TFile *nonfake_input_bdt1 = TFile::Open( "/cms/mchristos/ANN/FireMVA/outFiles/BDTnoMuonPt_TT_NonFakeMuonTree.root" ); 
  ...
  //Get skimmed TTrees (copied from /cms/multilepton-2/hsaka/Workspace/pyPlotter-2018Maxi/pyPlotter/FIREMVA/)
  TFile *fake_input_bdt2 = TFile::Open( "/cms/mchristos/ANN/FireMVA/outFiles/BDTnoMuonPt_TT_DYTrain_FakeMuonTree.root" ); 
  std::cout << "--- Using fakes input file: " << fake_input_bdt2->GetName() <<         std::endl;

  TFile *nonfake_input_bdt2 = TFile::Open( "/cms/mchristos/ANN/FireMVA/outFiles/BDTnoMuonPt_TT_DYTrain_NonFakeMuonTree.root" ); 
  ...
  //Draw
   ...
   roc->SaveAs("fakesEff_TT_OffDiagonal.png");
