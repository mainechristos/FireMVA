...
void pt_Eff_Master_ptTrain_DY( TString myMethodList = "" )
{
   float lumi = 1.;
   gStyle->SetOptStat(0);
   ...
   bdt1_WeightExpression += "BDT>.485";
   bdt2_WeightExpression += "BDT>.54";
   ...
   TFile *fakes_input_bdt2 = TFile::Open( "/cms/mchristos/ANN/FireMVA/outFiles/BDToptimized_DY_FakeMuonTree.root" ); 
   std::cout << "--- Using fakes input file: " << fakes_input_bdt2->GetName() <<         std::endl;

   TFile *nonfakes_input_bdt2 = TFile::Open( "/cms/mchristos/ANN/FireMVA/outFiles/BDToptimized_DY_NonFakeMuonTree.root" ); 
   ...
   Pteff_fakes->SaveAs("PtTrain_DY_fakes.png");
   ...
   Pteff_nonfakes->SaveAs("PtTrain_DY_nonfakes.png");
