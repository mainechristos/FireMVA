...
void pt_Eff_Master_opt_TT( TString myMethodList = "" )
{
   float lumi = 1.;
   gStyle->SetOptStat(0);
   ...
   bdt1_WeightExpression += "BDT>.9145"; //cuts for 82.3% sig eff
   bdt2_WeightExpression += "BDT>.823";
   ...
   TFile *fakes_input_bdt2 = TFile::Open( "/cms/mchristos/ANN/FireMVA/outFiles/BDT3params_TT_FakeMuonTree.root" ); 
   std::cout << "--- Using fakes input file: " << fakes_input_bdt2->GetName() <<         std::endl;

   TFile *nonfakes_input_bdt2 = TFile::Open( "/cms/mchristos/ANN/FireMVA/outFiles/BDT3params_TT_NonFakeMuonTree.root" ); 
   ...
   mg->Draw("AP");
   mg->SetTitle("Background Efficiency at 82.3\% Signal Efficiency");
   ...
   mg_nonfakes->Draw("AP");
   mg_nonfakes->SetTitle("Signal Efficiency at 82.3\% Total Signal Efficiency");
