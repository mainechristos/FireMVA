...
void Application_Fakes_4L_2016(){
  ...
  TFile *input(0);   
    //input = TFile::Open("/cms/mchristos/ANN/FireMVA/2016/runPlotter_4LonlyMC_NTupleMaker_2016/InputBundle_X+G_Input_31_Tree.root");
    input = TFile::Open("outFiles/Application_1_4L/InputBundle_X+G_Input_31_Tree/BDT2_tree.root");
  ...
  TTreeReaderValue<vector<float>> inLightLeptonPt(myReader, "LightLeptonPt");
   ...
   TTreeReaderValue<vector<int>> inLightLeptonFlavor(myReader, "LightLeptonFlavor");
    ...
    TFile *endfile = new TFile("outFiles/Application_1_4L/InputBundle_X+G_Input_31_Tree/BDT1_tree.root","RECREATE");   
