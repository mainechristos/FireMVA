...
void Application_Fakes_3L_2016(){
  ...
  TFile *input(0);   
    //input = TFile::Open("/cms/heindl/software/CMSSW_10_4_ROOT614_X_2018-10-19-2300/src/pyPlotter/runPlotter_3LonlyMC_NTupleMaker_2016_v2/InputBundle_Other_{Fake}_Input_116_Tree.root");
    input = TFile::Open("outFiles/Application_1/InputBundle_Other_{Fake}_Input_116_Tree/BDT2_tree.root");
  ...
  TTreeReaderValue<vector<float>> inLightLeptonPt(myReader, "LightLeptonPt");
   ...
   TTreeReaderValue<vector<int>> inElectronMissingHits(myReader, "ElectronMissingHits");
    ...
    TFile *endfile = new TFile("outFiles/Application_1/InputBundle_Other_{Fake}_Input_116_Tree/BDT3_tree.root","RECREATE");   
