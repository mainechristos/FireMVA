...
void Application_Fakes_2L_2016(){
  ...
  TFile *input(0);   
    //input = TFile::Open("/cms/heindl/software/CMSSW_10_4_ROOT614_X_2018-10-19-2300/src/pyPlotter/runPlotter_2L_NTupleMaker_2016/runPlotter_2L_NTupleMaker_2016/InputBundle_Data_Input_12_Tree.root");
    input = TFile::Open("outFiles/Application_1_2L/InputBundle_Data_Input_12_Tree/BDT2_tree.root");
  ...
  TTreeReaderValue<vector<float>> inLightLeptonPt(myReader, "LightLeptonPt");
   ...
   TTreeReaderValue<vector<int>> inLightLeptonFlavor(myReader, "LightLeptonFlavor");
    ...
    TFile *endfile = new TFile("/cms/multilepton-2/mchristos/BDTSkims/2016outFiles/Application_1_2L/InputBundle_Data_Input_12_Tree/BDT3_tree.root","RECREATE");   
