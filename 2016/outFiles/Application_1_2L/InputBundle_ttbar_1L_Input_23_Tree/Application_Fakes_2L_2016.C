...
void Application_Fakes_2L_2016(){
  ...
  reader1->BookMVA( "BDTG method",  "/cms/mchristos/ANN/FireMVA/2016/dl/weights/fire_MVA_FakeElectrons_BDT.weights.xml");
  reader2->BookMVA( "BDTG method",  "/cms/mchristos/ANN/FireMVA/2016/dl/weights/fire_MVA_FakeMuons_BDT.weights.xml");


  TFile *input(0);   
    input = TFile::Open(" /cms/heindl/software/CMSSW_10_4_ROOT614_X_2018-10-19-2300/src/pyPlotter16and17_No2/pyPlotter/runPlotter_2L_NTupleMaker_2017/InputBundle_ttbar_1L_Input_23_Tree.root");
    //input = TFile::Open("outFiles/Application_1_2L/InputBundle_ttbar_1L_Input_23_Tree/BDT2_tree.root");
  ...
  TTreeReaderValue<vector<float>> inLightLeptonPt(myReader, "LightLeptonPt");
   ...
   TTreeReaderValue<vector<int>> inElectronMissingHits(myReader, "ElectronMissingHits");
    ...
    TFile *endfile = new TFile("outFiles/Application_1_2L/InputBundle_ttbar_1L_Input_23_Tree/BDT5_tree.root","RECREATE");   
