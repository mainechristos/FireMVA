...
void Train_Electrons_Fakes( TString myMethodList = "" )
{
   ...
   TFile *fakes_input = TFile::Open( "/cms/mchristos/ANN/FireMVA/2016/DY_FakeElectronTree_PtNorm.root" ); 
   std::cout << "--- Using fakes input file: " << fakes_input->GetName() <<         std::endl;

   TFile *nonfakes_input = TFile::Open( "/cms/mchristos/ANN/FireMVA/2016/TT_FakeElectronTree_PtNorm.root" ); 
   ...
   //factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 2","!H:!V:NTrees=150:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=1.0:nCuts=2:MaxDepth=2" );
   //factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 5","!H:!V:NTrees=150:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=1.0:nCuts=5:MaxDepth=2" );
   //factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 10","!H:!V:NTrees=150:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=1.0:nCuts=10:MaxDepth=2" );
   //factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 20","!H:!V:NTrees=150:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=1.0:nCuts=20:MaxDepth=2" );
   //factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 100","!H:!V:NTrees=150:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=1.0:nCuts=100:MaxDepth=2" );
   
   
   //factory->BookMethod( dl, TMVA::Types::kBDT, "Identity","!H:!V:NTrees=150:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=1.0:nCuts=100:MaxDepth=2::VarTransform=I" );
   //factory->BookMethod( dl, TMVA::Types::kBDT, "PCA","!H:!V:NTrees=150:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=1.0:nCuts=100:MaxDepth=2::VarTransform=P" );
   //factory->BookMethod( dl, TMVA::Types::kBDT, "Decorrelation","!H:!V:NTrees=150:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=1.0:nCuts=100:MaxDepth=2::VarTransform=D" );
   //factory->BookMethod( dl, TMVA::Types::kBDT, "Gaussian","!H:!V:NTrees=150:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=1.0:nCuts=100:MaxDepth=2::VarTransform=G" );
   

   factory->BookMethod( dl, TMVA::Types::kBDT, "BDT","!H:!V:NTrees=150:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=1.0:nCuts=100:MaxDepth=2::VarTransform=I" );
