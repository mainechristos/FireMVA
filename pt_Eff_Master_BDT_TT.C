...
void pt_Eff_Master_BDT_TT( TString myMethodList = "" )
{
   float lumi = 1.;
   gStyle->SetOptStat(0);
   ...
   bdt1_WeightExpression += "BDT>.938";
   bdt2_WeightExpression += "BDT>.869";
   bdt3_WeightExpression += "BDT>.67";
   bdt4_WeightExpression += "BDT>-.025";
   bdt5_WeightExpression += "BDT>-.96";
   ...
   TFile *fakes_input_bdt2 = TFile::Open( "/cms/mchristos/ANN/FireMVA/outFiles/BDTnoMuonPt_TT_FakeMuonTree.root" ); 
   std::cout << "--- Using fakes input file: " << fakes_input_bdt2->GetName() <<         std::endl;

   TFile *nonfakes_input_bdt2 = TFile::Open( "/cms/mchristos/ANN/FireMVA/outFiles/BDTnoMuonPt_TT_NonFakeMuonTree.root" ); 
   ...
   TFile *fakes_input_bdt3 = TFile::Open( "/cms/mchristos/ANN/FireMVA/outFiles/BDTnoMuonPt_TT_FakeMuonTree.root" ); 
   std::cout << "--- Using fakes input file: " << fakes_input_bdt3->GetName() <<         std::endl;

   TFile *nonfakes_input_bdt3 = TFile::Open( "/cms/mchristos/ANN/FireMVA/outFiles/BDTnoMuonPt_TT_NonFakeMuonTree.root" ); 
   ...
   TFile *fakes_input_bdt4 = TFile::Open( "/cms/mchristos/ANN/FireMVA/outFiles/BDTnoMuonPt_TT_FakeMuonTree.root" ); 
   std::cout << "--- Using fakes input file: " << fakes_input_bdt4->GetName() <<         std::endl;

   TFile *nonfakes_input_bdt4 = TFile::Open( "/cms/mchristos/ANN/FireMVA/outFiles/BDTnoMuonPt_TT_NonFakeMuonTree.root" ); 
   ...
   TFile *fakes_input_bdt5 = TFile::Open( "/cms/mchristos/ANN/FireMVA/outFiles/BDTnoMuonPt_TT_FakeMuonTree.root" ); 
   std::cout << "--- Using fakes input file: " << fakes_input_bdt5->GetName() <<         std::endl;

   TFile *nonfakes_input_bdt5 = TFile::Open( "/cms/mchristos/ANN/FireMVA/outFiles/BDTnoMuonPt_TT_NonFakeMuonTree.root" ); 
   ...
   Pteff_fakes->SaveAs("PtFakes_Varied_Effs_TT.png");
   ...
   Pteff_nonfakes->SaveAs("PtNonFakes_Varied_Effs_TT.png");
