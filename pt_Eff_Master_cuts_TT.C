...
void pt_Eff_Master_cuts_TT( TString myMethodList = "" )
{
   float lumi = 1.;
   gStyle->SetOptStat(0);
   ...
   Pteff_fakes->SaveAs("optcuts_TT_fakes.png");
   ...
   Pteff_nonfakes->SaveAs("optcuts_TT_nonfakes.png");
