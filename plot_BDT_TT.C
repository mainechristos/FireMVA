void plot_BDT_TT(){
  ...
  TFile *fake_input_bdt2 = TFile::Open( "/cms/mchristos/ANN/FireMVA/outFiles/BDTnoMuonPt_TT_FakeMuonTree.root" ); 
  std::cout << "--- Using fakes input file: " << fake_input_bdt2->GetName() <<         std::endl;

  TFile *nonfake_input_bdt2 = TFile::Open( "/cms/mchristos/ANN/FireMVA/outFiles/BDTnoMuonPt_TT_NonFakeMuonTree.root" ); 
