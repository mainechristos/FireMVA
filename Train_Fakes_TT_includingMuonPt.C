...
void Train_Fakes_TT_includingMuonPt( TString myMethodList = "" )
{
   ...
   TString outfileName( "class_perf/fire_MVA_TT_optimized.root" );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

   TMVA::Factory *factory = new TMVA::Factory( "fire_MVA_TT_optimized", outputFile,
